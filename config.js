...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("27634624586")
...
global.gurl = 'https://instagram.com/Tristany71' // add your username
global.sudo = process.env.SUDO || '27656319889'
global.devs = '27634624586';
global.INBOX_BLOCK = 'true'
global.TIMEZONE = 'Africa/Johannesburg' 
...
module.exports = {
  ...
  ownernumber: process.env.OWNER_NUMBER === undefined ? '27634624586' : process.env.OWNER_NUMBER,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '🎀:Tristan' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝗦𝗛𝗘𝗡𝗨 𝗤𝗨𝗘𝗘𝗡 𝗠𝗗' : process.env.PACK_INFO.split(";")[1],	
  dl_limit: process.env.DL_SIZE || '950',
  autoreaction:  process.env.AUTO_REACTION  === undefined ? false : process.env.AUTO_REACTION ,
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'nbwoed' : process.env.ANTI_BAD_WORD,
  alwaysonline:  process.env.ALWAYS_ONLINE === undefined ? true : process.env.ALWAYS_ONLINE,
  antilink: process.env.ANTILINK_VALUES || 'chat.whatsapp.com;whatsapp.com/channel',
  antibadword : process.env.ANTI_BAD_WORD || 'fuck,xxx,sex,fucked,Brazzers,pornhub,huth,fucking,huththa,huththo,hukanna,fucked,pakaya,pako,ponnaya,ponnayo,kariya,kariyo,huththaa,hutta',
  ...
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'hey there☺️, i am alive now!' : process.env.ALIVE_MESSAGE,
  caption :process.env.CAPTION || "  \t🧚 *ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴄʏʙᴇʀ Tristan*",
